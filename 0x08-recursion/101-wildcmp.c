 ...
 * Return: true or false if the s1 and s2 can considerer equal
 * s2 can contain the special character *
 * The special char * can replace any string (including an empty string)
 * function that compares two strings and returns 1 if strings can be considered identical, otherwise return 0.
 */
